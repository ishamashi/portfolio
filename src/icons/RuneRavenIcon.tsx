// components/icons/RuneRavenIcon.tsx
// (Menggunakan kode dari jawaban sebelumnya)
import React from "react";

type RuneIconProps = React.SVGProps<SVGSVGElement>;

const RuneRavenIcon: React.FC<RuneIconProps> = (props) => (
  <svg
    ...
    fill="none"
    stroke="currentColor"
    strokeWidth="1.5" // Dibuat sedikit lebih tipis
    strokeLinecap="round"
