// components/about/SagaContent.tsx
import React from 'react';

const SagaContent = () => {
  return (
    <div className="prose prose-base dark:prose-invert max-w-none text-foreground/85 leading-relaxed space-y-5">
      <h2 className="font-mono !mb-4 !text-2xl border-b border-border/30 pb-2 text-accent">
        The First Spark: Awakening the Code-Smith
      </h2>
      <p>
        My journey into the digital realms began not unlike the Dwarves first striking ore in the dark – with immense curiosity. The flickering screen held mysteries, websites and applications functioned like intricate magical artifacts. How? This question ignited the forge within, pushing me to unravel the runes of HTML, CSS, and the ancient scripts of JavaScript. The alias <strong className="text-accent/90">[SleepyHead]</strong> emerged during late-night coding quests, a testament to the dedication (and occasional exhaustion) in pursuit of mastery.
      </p>
